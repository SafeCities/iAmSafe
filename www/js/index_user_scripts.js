 ...
 */
	...
	function pinsInit(){
		...
		$.post(apiUrl+'getAllPosts', {}, function(response){
			for(var key in response.data)
			{
				...
				var infoWindow = '<img src="'+response.data[key].photo+'" style="width:100%; height:auto;"><br><strong>'+response.data[key].category+'</strong><p>'+response.data[key].description.substring(0,256)+'...</p><center><button class="btn btn-sm">View</button><button class="btn btn-info btn-sm">Share</button></center>';
    ...
    $(document).on("click", "#btn-unsafe-post", function(evt)
    {
        ...
        /* button  #btn-help-done */
    $(document).on("click", "#btn-help-done", function(evt)
    {
         /*global activate_page */
         activate_page("#page-map"); 
         return false;
    ...
    {
         /*global activate_page */
         activate_page("#page-help"); 
         return false;
    });
    
        /* button  #btn-stories */
    $(document).on("click", "#btn-stories", function(evt)
    {
         /*global activate_page */
         activate_page("#page-stories"); 
         return false;
    });
    
        /* button  #btn-stories-done */
    $(document).on("click", "#btn-stories-done", function(evt)
    {
         /*global activate_page */
         activate_page("#page-map"); 
         return false;
